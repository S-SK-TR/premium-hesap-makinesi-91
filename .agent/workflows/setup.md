...
- `CLAUDE.md` dosyasındaki `Mini Calculator - Premium Basit Hesap Makinesi`, `Mini Calculator - Premium Basit Hesap Makinesi — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
